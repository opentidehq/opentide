...
**CodeQL:** single workflow [`.github/workflows/codeql.yml`](.github/workflows/codeql.yml) (`python` + `actions`). Disable duplicate Code Quality → CodeQL in repo settings. Local: `scripts/codeql-local.sh`.
