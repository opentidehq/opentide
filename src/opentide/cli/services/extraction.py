...
_FRAMEWORK_SCRIPTS: dict[ExtractFramework, str] = {
    ExtractFramework.attack: "Engines/extraction/attack.py",
    ExtractFramework.d3fend: "Engines/extraction/d3fend_artifacts.py",
    ExtractFramework.engage: "Engines/extraction/engage.py",
    ExtractFramework.nist: "Engines/extraction/nist.py",
    ExtractFramework.react: "Engines/extraction/atc_react.py",
}

_IMPORT_SCRIPTS: dict[ExtractImport, str] = {
    ExtractImport.sentinel: "Engines/extraction/sentinel_importer.py",
    ExtractImport.defender: "Engines/extraction/mde_importer.py",
}


def _run_engine_script(relative_path: str) -> None:
    """Execute an Engines script via runpy (preserves script-style side effects)."""
