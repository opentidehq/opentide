...
The latest release is **[0.6.1](./usage/releases.md)** (23 September 2026). The first public release was **0.1.0**. Pin `0.6.1` if you installed `0.6.0` or an earlier release from PyPI.
