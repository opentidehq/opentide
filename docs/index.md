...
The latest patch is **[0.1.1](./usage/releases.md)** (11 September 2026). The first public release was **0.1.0**. Pin `0.1.1` if you installed `0.1.0` from PyPI — that wheel breaks after pip compileall and mis-parses `setup skills discover`.
