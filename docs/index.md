...
The latest release is **[0.6.0](./usage/releases.md)** (23 September 2026). The first public release was **0.1.0**. Pin `0.6.0` if you installed `0.5.x`, `0.4.x`, `0.3.x`, `0.2.x`, or `0.1.x` from PyPI.
