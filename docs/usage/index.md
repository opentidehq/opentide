...
<Cards>
  ...
  <Card title="0.6.2 release" href="./releases.md" description="Current PyPI release — pin opentide==0.6.2 (GitLab base commit and GitHub pull-request refs)." />
</Cards>
...
| **Checking what shipped** | [Releases](./releases.md) | [0.6.2 on PyPI](https://pypi.org/project/opentide/0.6.2/) |
