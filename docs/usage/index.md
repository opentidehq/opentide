...
<Cards>
  ...
  <Card title="0.5.0 release" href="./releases.md" description="Current PyPI release — pin opentide==0.5.0 (threat impact and leverage are vocabulary lists, as threat::1.0 specifies)." />
</Cards>
...
| **Checking what shipped** | [Releases](./releases.md) | [0.5.0 on PyPI](https://pypi.org/project/opentide/0.5.0/) |
