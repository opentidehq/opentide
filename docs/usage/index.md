...
<Cards>
  ...
  <Card title="0.1.3 release" href="./releases.md" description="Current PyPI patch — pin opentide==0.1.3 (setup ci YAML, local deploy, tutorial, optional SDKs)." />
</Cards>
...
| **Checking what shipped** | [Releases](./releases.md) | [0.1.3 on PyPI](https://pypi.org/project/opentide/0.1.3/) |
