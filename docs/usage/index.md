...
<Cards>
  ...
  <Card title="0.6.0 release" href="./releases.md" description="Current PyPI release — pin opentide==0.6.0 (workspace discovery, human output, and unfinished repositories)." />
</Cards>
...
| **Checking what shipped** | [Releases](./releases.md) | [0.6.0 on PyPI](https://pypi.org/project/opentide/0.6.0/) |
