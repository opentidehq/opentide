...
<Cards>
  ...
  <Card title="0.6.3 release" href="./releases.md" description="Current PyPI release — pin opentide==0.6.3 (remaining CI diff failures)." />
</Cards>
...
| **Checking what shipped** | [Releases](./releases.md) | [0.6.3 on PyPI](https://pypi.org/project/opentide/0.6.3/) |
