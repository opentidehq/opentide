...
<Cards>
  ...
  <Card title="0.1.7 release" href="./releases.md" description="Current PyPI patch — pin opentide==0.1.7 (VS Code schemas, templates, and validate JSON)." />
</Cards>
...
| **Checking what shipped** | [Releases](./releases.md) | [0.1.7 on PyPI](https://pypi.org/project/opentide/0.1.7/) |
