...
<Cards>
  ...
  <Card title="0.1.8 release" href="./releases.md" description="Current PyPI patch — pin opentide==0.1.8 (first-time setup templates, platform TOML, and GitHub docs paths)." />
</Cards>
...
| **Checking what shipped** | [Releases](./releases.md) | [0.1.8 on PyPI](https://pypi.org/project/opentide/0.1.8/) |
