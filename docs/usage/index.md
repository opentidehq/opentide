...
<Cards>
  ...
  <Card title="0.4.0 release" href="./releases.md" description="Current PyPI release — pin opentide==0.4.0 (first-user fixes: offline validate query, MCP contracts, setup CI templates)." />
</Cards>
...
| **Checking what shipped** | [Releases](./releases.md) | [0.4.0 on PyPI](https://pypi.org/project/opentide/0.4.0/) |
