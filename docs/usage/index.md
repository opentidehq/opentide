...
<Cards>
  ...
  <Card title="0.6.1 release" href="./releases.md" description="Current PyPI release — pin opentide==0.6.1 (CI deploy plans, setup path, and promotion flags)." />
</Cards>
...
| **Checking what shipped** | [Releases](./releases.md) | [0.6.1 on PyPI](https://pypi.org/project/opentide/0.6.1/) |
