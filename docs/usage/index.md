...
<Cards>
  ...
  <Card title="0.1.4 release" href="./releases.md" description="Current PyPI patch — pin opentide==0.1.4 (threat.actors objects; generate no longer crashes)." />
</Cards>
...
| **Checking what shipped** | [Releases](./releases.md) | [0.1.4 on PyPI](https://pypi.org/project/opentide/0.1.4/) |
