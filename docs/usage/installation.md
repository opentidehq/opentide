...
The latest patch is **0.1.4** (13 September 2026). The first public release was **0.1.0** (9 September 2026). Notes: [Releases](./releases.md).

```bash
pip install opentide              # latest on PyPI
pip install 'opentide==0.1.4'     # pin the current patch
```
